...
const startIdx = code.indexOf('function buildSpellPrintHTML(char) {');
...
`;
  ...
  console.log('Replaced buildSpellPrintHTML');
} else {
  console.log('Could not find boundaries for buildSpellPrintHTML');
}
