...
const store = {
  'dnd55_characters': '[{"id":"1","level":1,"spells":[],"spellFavorites":[],"class":"Guerrero","stats":{"int":10,"wis":10,"cha":10}}]',
...
console.log('Prepared list HTML length:', document.getElementById('spellsListPrepared').innerHTML.length);
